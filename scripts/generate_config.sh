...
# MODULE_DIR_NAME = "$($1)"
echo "$(dirname "$MODULE_CONFIG_FILE_TEMPLATE")"
...
sed "s|__MODULE_NAME__|$1|g" "$MODULE_CONFIG_FILE_TEMPLATE" > "$MODULE_CONFIG_FILE"

echo "✅ Файл $MODULE_CONFIG_FILE создан с MODULE_NAME=$1"
